...
/**
 * Ciclo de vida do plugin. Na v0.0.1 nao cria tabelas: apenas semeia
...
class Activator {
	 ...
	 * @var string
	 */
	const SETTINGS_OPTION = MMB_OPTION_PREFIX . 'settings';
	 ...
	 * @var string
	 */
	const VERSION_OPTION = MMB_OPTION_PREFIX . 'version';
	...
	public static function activate() {
		...
		update_option( self::VERSION_OPTION, MMB_VERSION, false );
