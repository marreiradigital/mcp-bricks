...
class Token_Manager {
	 ...
	 * @var string
	 */
	const HASH_OPTION = MMB_OPTION_PREFIX . 'token_hash';
	 ...
	 * @var string
	 */
	const META_OPTION = MMB_OPTION_PREFIX . 'token_meta';
	...
	public static function generate() {
		$raw   = 'mmb_' . bin2hex( random_bytes( 32 ) );
		$hash  = hash( 'sha256', $raw );

		// Option nao-autoload (quarto parametro do add/update via funcoes proprias).
